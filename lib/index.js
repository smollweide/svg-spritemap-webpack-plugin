...
module.exports = class SVGSpritemapPlugin {
    ...
    apply(compiler) {
        ...
        compiler.hooks.make.tap(plugin, (compilation) => {
            ...
            const spritemap = generateSVG(this.files, outputOptions);
    ...
    updateDependencies() {
        ...
        this.files = inputOptions.pattern.reduce((accumulator, value) => {
        ...
        this.directories = inputOptions.pattern.reduce((accumulator, value) => {
