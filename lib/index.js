...
module.exports = class SVGSpritemapPlugin {
    constructor(options) {
        ...
        // TODO: Move these modifiers to a seperate file
    ...
    apply(compiler) {
        ...
        compiler.hooks.make.tap(plugin, (compilation) => {
            const spritemap = generateSVG(this.files, {
                ...
                generateUse: this.options.generateUse
            });
            ...
            compilation.hooks.additionalChunkAssets.tap(plugin, () => {
                ...
                sourceChunk.files.push(this.options.filename);
            });
            ...
            compilation.hooks.optimizeAssets.tapAsync(plugin, (assets, callback) => {
                ...
                const hashedAssets = this.rewriteAssetsHashes(this.options.filename, compilation.assets, hashes);
